...
Note that if you're [connecting to a Windows Docker installation from inside WSL](https://nickjanetakis.com/blog/setting-up-docker-for-windows-and-wsl-to-work-flawlessly), you may have rebound your `C:\` drive share from `/mnt/c` to `/c`, in which case you'll need to change the command below.
